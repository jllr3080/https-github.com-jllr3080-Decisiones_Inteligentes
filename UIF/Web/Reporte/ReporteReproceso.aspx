<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Reporte_Reproceso%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="ReporteReproceso.aspx.cs" Inherits="Web.Reporte.ReporteReproceso" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Reporte_Reproceso%>"/>
    </h2>
    <section>
            <div class="panel panel-default" id="_datosDescuento">
           <div class="panel-heading"><asp:Literal runat="server" ID="_literalEncabezado" Text="<%$ Resources:Web_es_Ec,Panel_Busqueda_Estado_Cuenta%>"/></div>
            ...
            <div class="row">
             ...
             <div class="row">
                 ...
                 <div class="col-md-3">
                  ...
                  <div class="col-md-3">
                            <asp:Button ID="_generarReporte" runat="server" Text="<%$ Resources:Web_es_Ec,Boton_Generar_Reporte%>"  ValidationGroup="Obligatorio" class="btn btn-primary" OnClick="_generarReporte_OnClick" />
                        </div>
        ...
        <div class="panel-body">
            <div class="row">
                   ...
                   <rsweb:ReportViewer ID="_reproceso" runat="server" Width="100%" AsyncRendering="False" ExportContentDisposition="AlwaysInline">
                    </rsweb:ReportViewer>
                    </div>
