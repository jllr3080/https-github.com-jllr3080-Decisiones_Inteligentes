...
{
    public partial class Marca : PaginaBase
    {
        ...
        protected void _datos_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            try
            {
                ...
                if (e.CommandName == "Editar")
                {
                    ...
                    _marca.Text = _datos.Rows[index].Cells[1].Text;
        ...
        protected void _ingresarInformacion_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                _marcaVistaModelo.MarcaId = Convert.ToInt32(_codigoInterno.Text);
                _marcaVistaModelo.Descripcion = _marca.Text.ToUpper();
                _marcaVistaModelo.EstaHabilitado = _estaHabilitado.Checked;

                if (actualizar == true)
                {
                    _servicioDelegadoGeneral.ActualizaMarca(_marcaVistaModelo);
                }
                else
                {
        ...
        {
            _datos.DataSource = _servicioDelegadoGeneral.ObtenerTodasMarcas();
            _datos.DataBind();
            actualizar = false;
