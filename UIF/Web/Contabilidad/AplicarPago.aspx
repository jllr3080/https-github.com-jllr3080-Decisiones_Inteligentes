    <%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Aplicar_Pago%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="AplicarPago.aspx.cs" Inherits="Web.Contabilidad.AplicarPago" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br>
   <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Aplicar_Pago%>"/>
    </h2>
         ...
         <div class="row">
              <div class="col-md-12">
                        <asp:GridView ID="_datos" runat="server" Width="100%" AutoGenerateColumns="False" OnRowCommand="_datos_OnRowCommand"  >
                            <Columns>
                             <asp:BoundField DataField="CierreMesId" HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" />
                            <asp:BoundField DataField="FechaCreacion" HeaderText="<%$ Resources:Web_es_Ec,Label_Cabecera_Grid_Fecha_Creacion%>" />
                            <asp:BoundField DataField="Valor" HeaderText="<%$ Resources:Web_es_Ec,Label_Cabecera_Grid_Valor%>" DataFormatString="{0:C2}" ItemStyle-HorizontalAlign="Right" ItemStyle-VerticalAlign="Middle" />
          ...
          <div class="panel panel-default">
           <div class="panel-heading"><asp:Literal runat="server" ID="Literal2" Text="<%$ Resources:Web_es_Ec,Panel_Aplicacion_Pago%>"/></div>
                <div class="panel-body">
                     ...
                     <div class="row">
                         <div class="col-md-3">
                                <asp:Label ID="_labelDocumento" runat="server" Text="<%$ Resources:Web_es_Ec,Label_Imagen_Documento%>"></asp:Label>
                        </div>
                     ...
                     <div class="row">
                          <div class="col-md-3">
                             <asp:UpdatePanel runat="server" ID="updatepanel2">
                                          <Triggers><asp:PostBackTrigger ControlID="_aplicarPago" /></Triggers>
                                        
                                          <ContentTemplate>
                                          <asp:FileUpload runat="server" ID="_documento" class="btn btn-primary"  ></asp:FileUpload>
                                          </ContentTemplate>
                                      </asp:UpdatePanel>
