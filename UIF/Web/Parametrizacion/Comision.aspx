<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Comision%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="Comision.aspx.cs" Inherits="Web.Parametrizacion.Comision" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br>
   <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Comision%>"/>
    </h2>
    <section>
            ...
            <div class="row">
                     <div class="col-md-12">
                                 <asp:GridView ID="_datos" runat="server" AutoGenerateColumns="False"  ShowFooter="True" Width="100%" OnRowCommand="_datos_OnRowCommand" OnRowDataBound="_datos_OnRowDataBound" AllowPaging="True" PageSize="5" OnPageIndexChanging="_datos_OnPageIndexChanging" >
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="VentaComisionId" />
