<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Estado_Cuenta%>"  Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="ReporteEstadoCuenta.aspx.cs" Inherits="Web.Reporte.ReporteEstadoCuenta" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Estado_Cuenta%>"/>
    </h2>
     <section>
        ...
        <div class="panel-body">
            <div class="row">
                   ...
                   <rsweb:ReportViewer ID="_estadoCuenta" runat="server" Width="100%" AsyncRendering="False" ExportContentDisposition="AlwaysInline">
                    </rsweb:ReportViewer>
                    </div>
