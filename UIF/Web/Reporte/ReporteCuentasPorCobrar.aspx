<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Reporte_Cuenta_Por_Cobrar%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="ReporteCuentasPorCobrar.aspx.cs" Inherits="Web.Reporte.ReporteCuentasPorCobrar" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br />
    <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Reporte_Cuenta_Por_Cobrar%>"/>
    </h2>
     <section>
