<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Impresion_Corta%>"Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="ReporteImpresionRapida.aspx.cs" Inherits="Web.Reporte.ReporteImpresionRapida" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br>
   <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Impresion_Corta%>"/>
    </h2>
    <section>
    ...
    <div class="panel panel-default" id="_datosBusquedaPorFecha">
     ...
     <div class="row" style="text-align:center ">
                   ...
                   <rsweb:ReportViewer ID="_impresion" runat="server" Width="100%" AsyncRendering="False" ExportContentDisposition="AlwaysInline" ShowPrintButton="True">
                    </rsweb:ReportViewer>
     </div>
    </section>
     <div class="row" >
