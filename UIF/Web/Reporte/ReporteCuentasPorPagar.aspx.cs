...
{
    public partial class ReporteCuentasPorPagar : PaginaBase
    {
        ...
        protected void _btnBusqueda_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string pathreport = Server.MapPath("~/Reporte/Contabilidad/ReporteCuentaPorPagar.rdlc");
                _reporte.LocalReport.ReportPath = pathreport;
                _reporte.LocalReport.DataSources.Add(new ReportDataSource("CuentasPorPagar", _servicioDelegadoContabilidad.ObtenerCuentaPorPagarPorFecha(Convert.ToInt32(_sucursal.SelectedItem.Value),_fechaDesde.Text,_fechaHasta.Text)));
