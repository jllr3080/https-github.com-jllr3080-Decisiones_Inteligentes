<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Promociones%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="Promocion.aspx.cs" Inherits="Web.Parametrizacion.Promocion" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br>
   <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Promociones%>"/>
    </h2>
     <section>
      <div class="panel panel-default" id="_datosIniciales">
        ...
        <div class="panel-body">
            ...
            <div class="row">
             ...
             <div class="row">
             <div class="col-md-6">
                            <asp:DropDownList ID="_sucursal" runat="server" CssClass="form-control" DataTextField="Descripcion" DataValueField="PuntoVentaId" AutoPostBack="True" OnSelectedIndexChanged="_sucursal_OnSelectedIndexChanged"></asp:DropDownList>        
                     </div>
      ...
      <div class="panel panel-default" id="_datos">
        ...
        <div class="panel-body">
            <div class="row">
                     <div class="col-md-12">
                                 <asp:GridView ID="_datos" runat="server" AutoGenerateColumns="False"  ShowFooter="True" Width="100%" OnRowCommand="_datos_OnRowCommand" OnRowDataBound="_datos_OnRowDataBound" AllowPaging="True" PageSize="5" OnPageIndexChanging="_datos_OnPageIndexChanging" >
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="Regla.ReglaId" />
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="Regla.FechaInicio" />
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="Regla.FechaFin" />
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="Regla.NombreRegla" />
                                    ...
                                    <ItemTemplate >
                                        <asp:ImageButton ID="_imgEditar" runat="server" ImageUrl="~/Content/Imagen/Editar.png"  CommandName="Editar" CommandArgument="<%# ((GridViewRow)Container).RowIndex %>" />
                                    </ItemTemplate>
                                    </asp:TemplateField>
