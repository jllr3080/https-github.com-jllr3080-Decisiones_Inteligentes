<%@ Page Title="<%$ Resources:Web_es_Ec,Titulo_Pagina_Marca%>" Language="C#" MasterPageFile="~/PaginaMaestra/Site.Master" AutoEventWireup="true" CodeBehind="Marca.aspx.cs" Inherits="Web.Parametrizacion.Marca" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <br>
   <h2>
        <asp:Literal runat="server" ID="_literalTitulo" Text="<%$ Resources:Web_es_Ec,Titulo_Pagina_Marca%>"/>
    </h2>
     <section>
      <div class="panel panel-default" id="_datosIniciales">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                 ...
                 <div class="col-md-3">
                                  <asp:TextBox ID="_marca" runat="server" CssClass="form-control" ValidationGroup="Obligatorio"  MaxLength="20" AutoCompleteType="Disabled" ></asp:TextBox>
            ...
            <div class="row">
                     <div class="col-md-12">
                                 <asp:GridView ID="_datos" runat="server" AutoGenerateColumns="False"  ShowFooter="True" Width="100%" OnRowCommand="_datos_RowCommand" OnRowDataBound="_datos_RowDataBound" >
                                    <Columns>
                                        <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Codigo_Interno%>" DataField="MarcaId" />
                                      <asp:BoundField HeaderText="<%$ Resources:Web_es_Ec,Label_Marca%>" DataField="Descripcion" />
